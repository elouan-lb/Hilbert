  ...
  return function (Module) {
    ...
    if (
      !Object.getOwnPropertyDescriptor(
        Module["ready"],
        "_coordinates_from_distance"
      )
    ) {
      Object.defineProperty(Module["ready"], "_coordinates_from_distance", {
        configurable: true,
        get: function () {
          abort(
            "You are getting _coordinates_from_distance on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js"
          );
        },
      });
      Object.defineProperty(Module["ready"], "_coordinates_from_distance", {
        ...
        set: function () {
          abort(
            "You are setting _coordinates_from_distance on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js"
          );
        },
      });
    }
    ...
    if (
      !Object.getOwnPropertyDescriptor(
        Module["ready"],
        "_distance_from_coordinates"
      )
    ) {
      Object.defineProperty(Module["ready"], "_distance_from_coordinates", {
        configurable: true,
        get: function () {
          abort(
            "You are getting _distance_from_coordinates on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js"
          );
        },
      });
      Object.defineProperty(Module["ready"], "_distance_from_coordinates", {
        ...
        set: function () {
          abort(
            "You are setting _distance_from_coordinates on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js"
          );
        },
      });
    }
    ...
    /** @type {function(...*):?} */
    var _coordinates_from_distance = (Module["_coordinates_from_distance"] =
      createExportWrapper("coordinates_from_distance"));

    /** @type {function(...*):?} */
    var _distance_from_coordinates = (Module["_distance_from_coordinates"] =
      createExportWrapper("distance_from_coordinates"));
